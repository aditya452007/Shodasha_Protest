...
export class CommentsService {
  public async listComments(postId: string, page = 1, limit = 50) {
  ...
  public async createComment(postId: string, input: CreateCommentInput, _fingerprint: string) {
