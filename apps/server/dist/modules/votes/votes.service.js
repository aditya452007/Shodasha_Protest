...
export class VotesService {
    async voteOnPost(postId, voteValue, voterHash) {
        ...
        const result = await db.transaction(async (tx) => {
            ...
            const newTrendingScore = calculateTrendingScore(newUpvotes, newDownvotes, targetPost.commentCount, targetPost.createdAt);
            await tx
                .update(posts)
                .set({
                upvotes: newUpvotes,
